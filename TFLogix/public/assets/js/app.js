...
var museums = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Bus Stop Name</th><td>" + feature.properties.NAME + "</td></tr>" + "<tr><th>Three Words</th><td>" + feature.properties.TEL + "</td></tr>" + "<tr><th>Air Quality</th><td>" + feature.properties.ADRESS1 + "</td></tr>" + "<tr><th>Temprature</th><td><a class='url-break' href='" + feature.properties.URL + "' target='_blank'>" + feature.properties.URL + "</a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.NAME);
          $("#feature-info").html(content);
...
attributionControl.onAdd = function (map) {
  ...
  div.innerHTML = "<span class='hidden-xs'>Developed by  Ambuj and Charles| </span><a href='#' onclick='$(\"#attributionModal\").modal(\"show\"); return false;'>Attribution</a>";
  return div;
};
...
var groupedOverlays = {
  "Transport": {
    "<img src='assets/img/museum.png' width='24' height='28'>&nbsp;Bus Stops": museumLayer
  }
};
